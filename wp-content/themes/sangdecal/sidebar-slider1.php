				...
				<?php else:
					...
					if( $slides->have_posts() ) : ?>
						...
						<?php while( $slides->have_posts() ) : $slides->the_post();
							...
							?>
							<?php $slider_heading = get_post_meta($post->ID, '_nectar_slider_heading', true); ?>
							<div class="slide orbit-slide <?php if( !empty($video_embed) || !empty($video_m4v) || !empty($video_ogv)) { echo 'has-video'; } else { echo $alignment; } ?>">
								...
								<article <?php /* data-background-cover="<?php echo (!empty($options['slider-background-cover']) && $options['slider-background-cover'] == 1) ? '1' : '0'; ?>" style="background-image: url('<?php echo $image; ?>'); background-size: 100% 100%;" */ ?>>
									<div class="container">
										<div class="row">
											<img src="<?php echo $image; ?>" alt="<?php echo $slider_heading; ?>" title="<?php echo $slider_heading; ?>">
											<?php /* <div class="col span_8 col_image"><img width="100%" src="<?php echo $image; ?>" alt="<?php echo $slider_heading; ?>"></div> */ ?>
											<div class="col col_left">
												<div class="post-title">
													...
													if(!empty($button)) { ?>
														<!-- <a href="<?php echo $button_url; ?>" class="button uppercase"><?php echo $button; ?></a> -->
