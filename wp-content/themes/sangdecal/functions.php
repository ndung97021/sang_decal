...
function nectar_register_js() {	
	...
	if (!is_admin()) { 
		...
		wp_register_script('bxslider', get_template_directory_uri() . '/bxslider/jquery.bxslider.min.js', 'bxslider', '4.8.1', TRUE);
		wp_register_script('slicknav', get_template_directory_uri() . '/js/jquery.slicknav.min.js', 'jquery', '4.8.1', TRUE);
...
function nectar_page_specific_js() {
	...
	//home
	if ( is_page_template('template-subpage.php') || is_page_template('template-home-1.php') || $template_name == 'salient/template-home-1.php' ||
...
function nectar_main_styles() {	
		 ...
		 wp_register_style("animate-css", get_template_directory_uri() . "/css/animate.css", '', '1.0.0');	
		 ...
		 wp_register_style('bxslider', get_template_directory_uri() . '/bxslider/jquery.bxslider.css');
		 wp_register_style("responsive-website", get_template_directory_uri() . "/css/responsive-website.css", '', '4.8.1');
		 ...
		 if( !empty($options['responsive']) && $options['responsive'] == 1 ) { 
			...
			wp_enqueue_style('responsive-website');
		 } else { 
...
function nectar_page_sepcific_styles() {
	...
	//home
	if ( is_page_template('template-subpage.php') || is_page_template('template-home-1.php') || is_page_template('template-home-2.php') || is_page_template('template-home-3.php') || is_page_template('template-home-4.php')) {
