...
/***************** Caroufredsel ******************/
	...
	function standardCarouselInit() {
		$('.carousel:not(".clients")').each(function(){
			var $that = $(this);
			var maxCols = $(this).parents('.carousel-wrap').attr('data-max-cols');
			var colWidth = $(this).parents('.carousel-wrap').attr('data-col-width');
			var scrollNum = $(this).parents('.carousel-wrap').attr('data-scroll-num');

			maxCols = maxCols ? parseInt(maxCols) : 4;
			colWidth = colWidth ? parseInt(colWidth) : 264;
			scrollNum = scrollNum ? parseInt(scrollNum) : '';

			maxCols = ($(this).parents('.carousel-wrap').attr('data-full-width') == 'true') ? 'auto' : maxCols;// 4;// 3 ;
			scrollNum = ($(this).parents('.carousel-wrap').attr('data-full-width') == 'true') ? 'auto' : scrollNum; // ''
			colWidth = ($(this).parents('.carousel-wrap').attr('data-full-width') == 'true') ? 500 : colWidth;// 264;// 353 ;
