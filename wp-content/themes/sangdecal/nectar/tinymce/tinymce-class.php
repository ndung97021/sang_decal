...
$nectar_shortcodes['carousel'] = array( 
	...
	'attr'=>array(
		...
		'max_cols'=>array(
			'type'=>'text',
			'title'=> __('Max Column', NECTAR_THEME_NAME),
			'desc' => __('Enter max column to show (default is 4)', NECTAR_THEME_NAME),
		),
		'col_width'=>array(
			'type'=>'text',
			'title'=> __('Column Width', NECTAR_THEME_NAME),
			'desc' => __('Enter column width (default is: Max Column = 4, width = 264; Max Column = 3, width = 353)', NECTAR_THEME_NAME),
		),
		'scroll_num'=>array(
			'type'=>'text',
			'title'=> __('Scroll Number', NECTAR_THEME_NAME),
			'desc' => __('Enter the scroll number of the carousel (default 1)', NECTAR_THEME_NAME),
		),
		'full_width'=>array(
			'type'=>'checkbox', 
			'title'=> __('Is Full Width', NECTAR_THEME_NAME),
			'desc' => __('Would you like the carousel show full width?', NECTAR_THEME_NAME),
		),
		'autorotate'=>array(
			'type'=>'checkbox',
		...
		'easing'=>array(
			'type'=>'select',
			'title'=> __('Tag Name', NECTAR_THEME_NAME),
			'values'=> array(
				'h1'=>'h1',
				'h2'=>'h2',
				'h3'=>'h3',
			...
			"desc" => "Render title of carousel with Tag Name."
		),
	)
);
...
function nectar_option_element( $name, $attr_option, $type, $shortcode ){
	...
	case 'custom':
		...
		elseif( $name == 'testimonials' ){
			...
			<div class="label"><label for="shortcode-option-swap_name"><strong>Show Name First?: </strong></label></div>
			<div class="content"><input class="disable_height_animation" type="checkbox" data-attrname="swap_name" value="0" />If you want to show Name before Quote</div>

			<div class="label"><label for="shortcode-option-once_icon"><strong>Next: One Icon?: </strong></label></div>
			<div class="content"><input class="disable_height_animation" type="checkbox" data-attrname="once_icon" value="0" />If you want to show one icon for next slide</div>

			<div class="label"><label for="shortcode-option-name_tag"><strong>Tag Of Name: </strong></label></div>
			<div class="content"><select data-attrname="name_tag">
			...
			<div class="shortcode-dynamic-items testimonials" id="options-item" data-name="testimonial">
				<div class="shortcode-dynamic-item">
					...
					<div class="content"><input class="shortcode-dynamic-item-image" type="text" name="image" value="" /></div>
					...
					<div class="label"><label><strong>Use Quote Text?</strong></label></div>
					<div class="content"><select class="shortcode-dynamic-item-quote_text" id="quote_text" name="quote_text">
							<option value="1">Yes</option>
							<option value="0">No</option>
						</select></div>
					<div class="label"><label><strong>Extra HTML: </strong></label></div>
					<div class="content"><textarea class="extra_html" name="extra_html"></textarea></div>
					<div class="label"><label><strong>Extra HTML: </strong></label></div>
					<div class="content"><text class="extra_class" type="text" name="extra_class"/></div>
				</div>
			</div>
