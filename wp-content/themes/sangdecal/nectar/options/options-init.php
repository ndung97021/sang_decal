...
function setup_framework_options(){
	...
	$sections[] = array(
        ...
        'fields' => array( 
            ...
            array(
                'id' => 'right-image',
                'type' => 'upload',
                'title' => __('Right Header Image', NECTAR_THEME_NAME),
                'sub_desc' => __('Upload Right Header Image.', NECTAR_THEME_NAME),
                'desc' => ''
            ),
            array(
                'id' => 'slogan_align',
                'type' => 'text',
                'title' => __('Slogan Align in Header', NECTAR_THEME_NAME),
                'sub_desc' => __('Slogan align ("left" or "right"; default "left").', NECTAR_THEME_NAME),
                'desc' => ''
            ),
            array(
                'id' => 'slogan',
                'type' => 'text',
                'title' => __('Slogan Header', NECTAR_THEME_NAME),
                'sub_desc' => __('Slogan for header.', NECTAR_THEME_NAME),
                'desc' => ''
            ),
            array(
                'id' => 'sub_slogan_align',
                'type' => 'text',
                'title' => __('Sub Slogan Align in Header', NECTAR_THEME_NAME),
                'sub_desc' => __('Sub Slogan align ("left" or "right"; default "left").', NECTAR_THEME_NAME),
                'desc' => ''
            ),
            array(
                'id' => 'sub_slogan',
                'type' => 'text',
                'title' => __('Sub Slogan Header', NECTAR_THEME_NAME),
                'sub_desc' => __('Sub slogan for header.', NECTAR_THEME_NAME),
                'desc' => ''
            ),
            array(
                'id' => 'extra_text_align',
                'type' => 'text',
                'title' => __('Extra Text Align Of Header', NECTAR_THEME_NAME),
                'sub_desc' => __('Extra Text Align Of Header ("left" or "right"; default "left").', NECTAR_THEME_NAME),
                'desc' => ''
            ),
            array(
                'id' => 'extra_text',
                'type' => 'textarea',
                'title' => __('Extra Text Of Header', NECTAR_THEME_NAME),
                'sub_desc' => __('Extra text of header, bellow the slogan .', NECTAR_THEME_NAME),
                'desc' => ''
            ),
            array(
                'id' => 'logo-height',
	 ...
	 $sections[] = array(
        ...
        'fields' => array(
			...
			array(
                ...
                'desc' => '',
                'std' => '#777777',
                'id' => 'footer-copyright-text-extra',
                'type' => 'textarea',
                'title' => __('Footer Copyright Section Text extra', NECTAR_THEME_NAME),
                'sub_desc' => __('Please enter the copyright section text extra. e.g. All Rights Reserved, Salient Inc.', NECTAR_THEME_NAME),
                'desc' => __('', NECTAR_THEME_NAME)
            ),
            ...
            array(
                ...
                'type' => 'textarea',
                'title' => __('Footer Location Section Text', NECTAR_THEME_NAME),
                'sub_desc' => __('Please enter the location section text', NECTAR_THEME_NAME),
                'desc' => __('', NECTAR_THEME_NAME)
            ),
            ...
            array(
                'id' => 'footer-menu-slug',
                'type' => 'text',
                'title' => __('Footer Menu Name/Slug Section', NECTAR_THEME_NAME),
                'sub_desc' => __('Please enter the menu name/slug section.', NECTAR_THEME_NAME),
                'desc' => __('', NECTAR_THEME_NAME)
            ),
            ...
            array(
                'id' => 'footer-menu-text',
                'type' => 'text',
                'title' => __('Footer Menu Section Text', NECTAR_THEME_NAME),
                'sub_desc' => __('Please enter the title of menu section text.', NECTAR_THEME_NAME),
                'desc' => __('', NECTAR_THEME_NAME)
            ),
            ...
            array(
                'id' => 'use-social-icons',
                'type' => 'checkbox',
                'title' => __('Use Social Icons', NECTAR_THEME_NAME),
                'sub_desc' => '',
                'desc' => ''
            ),
	...
	text_color="dark"
	text_align="left"
	vertically_center_columns="true"
	top_padding="0"
	bottom_padding="0"
	class="mapgoogle"][vc_column width="1/1"][nectar_gmap zoom="14"
		marker_image="72" size="400"
		map_center_lat="-33.753029"
		map_center_lng="151.146004"
		map_markers="-33.753029|151.146004|Level 2 , 27 Merriwa St Gordon NSW 2066"][/vc_column][/vc_row][vc_row][vc_column width="2/3"][vc_column_text]
	*/
    /*
    array(
        'id' => 'footer-google-maps',
        'type' => 'textarea',
        'title' => __('Footer Google Maps Section', NECTAR_THEME_NAME),
        'sub_desc' => __('Please enter iframe of Google Maps. <a target="_blank" href="https://www.google.com/maps">Click Here</a> to input address of google maps', NECTAR_THEME_NAME),
        'desc' => __('', NECTAR_THEME_NAME)
    ),
    */
	...
	$sections[] = array(
        ...
        'fields' => array( 	
       		 array(
                'id' => 'map-enable-footer-show',
                'type' => 'checkbox_hide_below',
                'title' => __('Toggle show Google Map at Footer', NECTAR_THEME_NAME),
                'sub_desc' => __('Toggle show Google Map at Footer', NECTAR_THEME_NAME),
                'desc' => '',
                #'next_to_hide' => '3',
                'switch' => true,
                'std' => '0'
            ...
            array(
                'id' => 'map_content_type',
                'type' => 'text',
                'title' => __('Show Google Map content width:', NECTAR_THEME_NAME),
                'sub_desc' => __('Value of text field is "in_container" or "full_width_background" or "full_width_content"; Default use "in_container"', NECTAR_THEME_NAME),
                'desc' => '',
                 /*'value' => array(
            ...
            array(
                'id' => 'map-size',
                'type' => 'text',
                'title' => __('Google Maps Size', NECTAR_THEME_NAME),
                'sub_desc' => __('Value of Google Maps Size (Default 450).', NECTAR_THEME_NAME),
                'desc' => '',
                'validate' => 'numeric'
            ),
            array(
	...
	$sections[] = array(
        ...
        'fields' => array( 
            array(
                'id' => 'slider-margin-header-top',
                'type' => 'text',
                'title' => __('Slider margin header top', NECTAR_THEME_NAME),
                'sub_desc' => __('When slider scroll to top and max margin to show background of header menu.', NECTAR_THEME_NAME),
                'desc' => __('', NECTAR_THEME_NAME),
                'validate' => 'numeric'
            ),
            array(
			...
			array(
             ...
             array(
                'id' => 'slider-show-menu-active',
                'type' => 'checkbox',
                'title' => __('Show Menu in Slider Active', NECTAR_THEME_NAME),
                'sub_desc' => __('Show Menu in Slider Active ', NECTAR_THEME_NAME),
                'desc' => '',
                'std' => '#000000'
            ),                   
        )
