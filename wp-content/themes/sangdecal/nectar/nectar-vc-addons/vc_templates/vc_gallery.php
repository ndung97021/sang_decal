...
if ( $type == 'flexslider_style' ) {
	...
	<div class="portfolio-wrap <?php if($gallery_style == '1' && $span_num == 'elastic-portfolio-item') echo 'default-style'; ?>">
			...
			<div id="portfolio" class="row portfolio-items no-masonry <?php echo $constrain_col_class . ' ' . $cols; ?>" data-starting-filter="" data-categories-to-show="" data-col-num="<?php echo $cols; ?>">
