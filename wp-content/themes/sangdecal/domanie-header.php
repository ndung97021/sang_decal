  ...
  <div class="container">
    <nav>
      ...
      <ul id="social">
        ...
        <li><a target="_blank" href="<?php echo $options['youtube-url']; ?>"><i class="icon-youtube"></i> </a></li>
        <?php } ?>
        ...
        <li><a target="_blank" href="<?php echo $options['dribbble-url']; ?>"><i class="icon-dribbble"></i> </a></li>
        <?php } ?>
        ...
        <li><a target="_blank" href="<?php echo $options['stackexchange-url']; ?>"><i class="icon-stackexchange"></i></a></li>
        <?php } ?>
      ...
      <div class="row">
        <div class="col span_12 col_last">
          <div id="menuzord" class="menuzord red"> 
            ...
            <div class="col span_3"> <a id="logo" href="<?php echo home_url(); ?>" <?php echo $logo_class; ?>>
            ...
            <ul class="menuzord-menu">
              <li><a href="http://sydneymortgagebrokers.com.au/about-us/" class="parent"><i class="icon-angle-down"></i> About Us</a>
                <div class="megamenu">
                  <div class="megamenu-row">
                    <div class="row">
                      <div class="col6"> <a href="http://sydneymortgagebrokers.com.au/about-us/">
                        <h2>About Us</h2>
                        </a>
                        <p>Dear Visitor,
                          Welcome to First Choice. We are a boutique Finance Planning firm that provides clients with guidance through ...</p>
                        <div class="row"> <a href="http://sydneymortgagebrokers.com.au/why-you-should-use-first-choice/">
                          <div class="submenu"> Why You First Choice <i class="icon-angle-right"></i></div>
                          </a> <a href="http://sydneymortgagebrokers.com.au/client-testimonials/">
                          <div class="submenu"> Client testimonials <i class="icon-angle-right"></i></div>
                          </a><a href="http://sydneymortgagebrokers.com.au/contact-us/">
                          <div class="submenu"> Contact Us <i class="icon-angle-right"></i></div>
                          </a> <a href="http://sydneymortgagebrokers.com.au/privacy-policy/">
                          <div class="submenu"> Privacy <i class="icon-angle-right"></i></div>
                          </a> </div>
                      </div>
                      <div class="col6 text-center"> <img src="/wp-content/themes/firstcho/img/menu-1.png" alt=""> 
                        <!--<a href="/home-loan-report"><h2>Your Free Home Loan Report <span class="glyphicon glyphicon-chevron-right"></span></h2></a>
												<p>Get started to find out your lowest rate, borrowing power, repayment amount and how many lenders you qualify for. Plus receive your FREE suburb report of choice.</p>--> 
                      </div>
                    </div>
                  </div>
                </div>
              </li>
              <li><a href="http://sydneymortgagebrokers.com.au/life-insurance/" class="parent"><i class="icon-angle-down"></i> Life Insurance</a>
                <div class="megamenu">
                  <div class="megamenu-row">
                    <div class="row">
                      <div class="col6"> <a href="http://sydneymortgagebrokers.com.au/life-insurance/">
                        <h2>Life Insurance</h2>
                        </a>
                        <p>Most Australians understand the importance of taking out insurance and the first type of insurance that springs to mind is Life Insurance. Put simply,...</p>
                        <div class="row"> <a href="http://sydneymortgagebrokers.com.au/why-you-should-use-first-choice/">
                          <div class="submenu"> Why You First Choice <i class="icon-angle-right"></i></div>
                          </a> <a href="http://sydneymortgagebrokers.com.au/client-testimonials/">
                          <div class="submenu"> Client testimonials <i class="icon-angle-right"></i></div>
                          ...
                          <!--<a href="/boat-loans"><div class="submenu"> Boat Loans  <i class="icon-angle-right"></i></div></a>
<a href="/investment/"><div class="submenu"> Property Investment  <i class="icon-angle-right"></i></div></a>--> 
                        </div>
                      </div>
                      <div class="col6 text-center"> <img src="/wp-content/themes/firstcho/img/menu-2.jpg" alt=""> 
                        <!--<a href="/home-loan-report"><h2>Need Money For A New Car?</h2></a>
												<p>Your dedicated car loan consultant will compare 10+ lenders and multiple car loan deals to find a loan that suits your needs. We also take care of the paperwork!</p>--> 
                      </div>
                    </div>
                  </div>
                </div>
              </li>
              <li><a href="http://sydneymortgagebrokers.com.au/total-and-permanent-disability/" class="parent"><i class="icon-angle-down"></i> Total & Permanent Dis. </a>
                <div class="megamenu">
                  <div class="megamenu-row">
                    <div class="row">
                      <div class="col6"> <a href="http://sydneymortgagebrokers.com.au/total-and-permanent-disability">
                        <h2>Total & Permanent Disability</h2>
                        </a>
                        <p>Total & Permanent Disability Insurance provides a lump sum in the event that the person insured becomes totally or permanently disabled, ...</p>
                        <div class="row"> <a href="http://sydneymortgagebrokers.com.au/why-you-should-use-first-choice/">
                          <div class="submenu"> Why You First Choice <i class="icon-angle-right"></i></div>
                          </a> <a href="http://sydneymortgagebrokers.com.au/client-testimonials/">
                          <div class="submenu"> Client testimonials <i class="icon-angle-right"></i></div>
                      ...
                      <div class="col6 text-center"> <img src="/wp-content/themes/firstcho/img/menu-3.png" alt=""> 
                        <!--<a href="/home-loan-report"><h2>Life Insurance Quote</h2></a>
												<p>Take the first step towards securing your family’s future today with a cost and obligation free life Insurance quote!</p>--> 
                      </div>
                    </div>
                  </div>
                </div>
              </li>
              <li><a href="http://sydneymortgagebrokers.com.au/traumacritical-illness/" class="parent"><i class="icon-angle-down"></i> Trauma/Critical Illness</a>
                <div class="megamenu">
                  <div class="megamenu-row">
                    <div class="row">
                      <div class="col6"> <a href="http://sydneymortgagebrokers.com.au/traumacritical-illness/">
                        <h2>Critical Illness or Trauma Insurance</h2>
                        </a>
                        <p>Critical Illness fills the gap between Life Insurance, Income Protection and Total and Permanent Disability insurance. The major benefit of a Critical Illness insurance policy... </p>
                        <div class="row"> <a href="http://sydneymortgagebrokers.com.au/why-you-should-use-first-choice/">
                          <div class="submenu"> Why You First Choice <i class="icon-angle-right"></i></div>
                          </a> <a href="http://sydneymortgagebrokers.com.au/client-testimonials/">
                          <div class="submenu"> Client testimonials <i class="icon-angle-right"></i></div>
                      ...
                      <div class="col6 text-center"> <img src="/wp-content/themes/firstcho/img/menu-4.png" alt=""> 
                        <!--<a href="/home-loan-report"><h2>Lender Competition Gets Hotter as the Weather Warms</h2></a>
												<p>Spring is traditionally one of the most active periods for real estate buying and selling. Therefore, as the weather warms...</p>--> 
                      </div>
                    </div>
                  </div>
                </div>
              </li>
              <li><a href="http://sydneymortgagebrokers.com.au/income-protection-insurance/" class="parent"><i class="icon-angle-down"></i> Income Protection</a>
                <div class="megamenu">
                  <div class="megamenu-row">
                    <div class="row">
                      <div class="col6"> <a href="http://sydneymortgagebrokers.com.au/income-protection-insurance/">
                        <h2>Income Protection Insurance</h2>
                        </a>
                        <p>Income Protection as the name suggests is a form that replaces your income in the event that you are unable to work for an extended period of time....</p>
                        <div class="row"> <a href="http://sydneymortgagebrokers.com.au/why-you-should-use-first-choice/">
                          <div class="submenu"> Why You First Choice <i class="icon-angle-right"></i></div>
                          </a> <a href="http://sydneymortgagebrokers.com.au/client-testimonials/">
                          <div class="submenu"> Client testimonials <i class="icon-angle-right"></i></div>
                      ...
                      <div class="col6 text-center"> <img src="/wp-content/themes/firstcho/img/menu-5.png" alt=""><!-- <a href="/home-loan-report">
                        <h2>An Award Winning Brand</h2>
                        </a>
                        <p>eChoice is continually being acknowledged as an industry leader. We have already helped 50,000 Australians find the right home loan– let us help you!</p>-->
                      </div>
                    </div>
                  </div>
                </div>
              </li>
             <!-- <li><a href="/contact" class="parent">Contact Us</a></li>-->
            </ul>
          </div>
          <div class="phone-support"> <strong>987 654 6546</strong> </div>
        </div>
        <!--/span_9--> 
  ...
  <div class="cart-outer">
    <div class="cart-menu-wrap">
      <div class="cart-menu"> <a class="cart-contents" href="<?php echo $woocommerce->cart->get_cart_url(); ?>">
    ...
    <div class="cart-notification"> <span class="item-name"></span> <?php echo __('was successfully added to your cart.', NECTAR_THEME_NAME); ?> </div>
    <?php
...
<div id="ajax-loading-screen" data-method="<?php echo (!empty($options['transition-method'])) ? $options['transition-method'] : 'ajax' ; ?>"><span class="loading-icon <?php echo (!empty($options['loading-image-animation']) && !empty($options['loading-image'])) ? $options['loading-image-animation'] : null; ?>">
  <?php if(empty($options['loading-image'])) { if(!empty($options['theme-skin']) && $options['theme-skin'] == 'ascend') { echo '<span class="default-loading-icon spin"></span>'; } else { echo '<span class="default-skin-loading-icon"></span>'; } } ?>
  </span></div>
