...
<div class="slide-container">
	<div class="container">
			<?php
			if( !empty($output) && strpos($output, 'slide orbit-slide') !== false ) {
				echo $output;
			} else {
				$html = do_shortcode('[vc_row type="in_container" bg_position="left top" bg_repeat="no-repeat" scene_position="center" text_color="dark" text_align="left" class="banner"][vc_column width="1/1"][nectar_slider location="Home Slide" max_columns="1" arrow_navigation="true" bullet_navigation="true" desktop_swipe="false" loop="true" slider_transition="slide" autorotate="5000"][/vc_column][/vc_row]');
